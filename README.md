...
Занимаюсь проектами в датаинженирии, созданием DWH, ETL-процессов. 

## Инструменты: 

Python, SQL, Airflow, Kafka, Spark Structured Streaming, PySpark, Hadoop, PostgreSQL, MySQL, Microsoft SQL Server, ClickHouse, MongoDB, Valkey, Vertica, Docker, Kubernetes, Yandex Cloud, DataLens, S3.
...
https://github.com/TatyanaBorisovaV/DWH_Couriers_dwh_multi-sources
* Выполняла выгрузку данных из S3 и построила DWH на базе Vertica на базе модели Data Vault;
https://github.com/TatyanaBorisovaV/Social_Network_Communities_Analytics_Vertica_DWH
* Разрабатывала хранилище данных Data Lake с использованием Hadoop и PySpark;
https://github.com/TatyanaBorisovaV/Social_Network_Geo_Analytics_Friend_Recommendation_System
* Реализовывала потоковую обработку данных из Kafka с использованием Spark Structured Streaming и Python в режиме реального времени;
